...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_DIR, '../db/django_tutorial.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'z=ud#qwglv!u2x$7h0)#jka8e*6f=nbw8zgh_3m4f^2e8j^$&amp;t'
...
TEMPLATE_DIRS = (
    ...
    os.path.join(PROJECT_DIR, 'templates/'), # Change this to your own directory.
)
